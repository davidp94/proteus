...
func (s *TransformerSuite) TestTransform() {
	...
	s.Equal("gopkg.in/davidp94/proteus.v1/fixtures", pkg.Path)
	...
	s.Equal([]string{
		...
		"google/protobuf/timestamp.proto",
		"gopkg.in/davidp94/proteus.v1/fixtures/subpkg/generated.proto",
	}, pkg.Imports)
	...
	s.Equal("gopkg.in/davidp94/proteus.v1/fixtures/subpkg", pkg.Path)
...
const project = "gopkg.in/davidp94/proteus.v1"
